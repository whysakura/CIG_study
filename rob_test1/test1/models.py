...
class Station(models.Model):
	station_number=models.CharField(max_length=40,primary_key=True)
...
class Linebody(models.Model):
	...
	wuliao_id=models.CharField(max_length=40,default='')#物料点号
	station_number=models.ForeignKey(Station)#站点号
	material_number=models.ForeignKey(Material)#物料号
	def __str__(self):
